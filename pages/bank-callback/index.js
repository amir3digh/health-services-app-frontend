...
export default function BankCallback() {
    ...
    useEffect(() => {
        const verifiedMsg = <div className={styles.summary}>درخواست شما با موفقیت ثبت شد</div>;
        const rejectMsg = <div className={styles.summary}>درخواست شما ثبت نشد</div>;
        const verifiedDetail = (
            <div className={styles.detail}>
                <div>کارشناسان ما پس از بررسی درخواست شما</div>
                <div>با شما تماس خواهند گرفت</div>
            </div>
        );
        const rejectDetail = <div className={styles.detail}>برای ثبت یا پرداخت مجدد دوباره تلاش کنید</div>;
